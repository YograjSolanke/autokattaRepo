    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (mSuggestionList.get(position).getStoreImage().equals("")) {
            ...
            Glide.with(mActivity)
                    .load(mActivity.getString(R.string.base_image_url) + mSuggestionList.get(position).getStoreImage())
        ...
        mStoreSuggestions.mView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                b.putString("StoreContact", mSuggestionList.get(mStoreSuggestions.getAdapterPosition()).getContactNo());
