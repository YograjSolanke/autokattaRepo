...
/**
 * Created by ak-005 on 20/11/17.
 */

public class TransferEnquiriesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {

    Activity mActivity;
    List<ManualEnquiryRequest> mItemList = new ArrayList<>();
    private List<ManualEnquiryRequest> mFilterData = new ArrayList<>();
    private TransferEnquiriesAdapter.CustomFilter filter;
    private ItemClickListener clickListener;

    public TransferEnquiriesAdapter(Activity mActivity, List<ManualEnquiryRequest> mItemList) {
   ...
   */
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        switch (holder.getItemViewType()) {
            case 1:
                TransferEnquiriesAdapter.UsedVehicleDetails vehicleDetails = (TransferEnquiriesAdapter.UsedVehicleDetails) holder;
            ...
            case 2:
                TransferEnquiriesAdapter.ProductDetails productDetails = (TransferEnquiriesAdapter.ProductDetails) holder;
            ...
            case 3:
                TransferEnquiriesAdapter.ServiceDetails serviceDetails = (TransferEnquiriesAdapter.ServiceDetails) holder;
            ...
            case 4:
                TransferEnquiriesAdapter.NewVehicleDetails newVehicleDetails = (TransferEnquiriesAdapter.NewVehicleDetails) holder;
    ...
    public Filter getFilter() {
        if (filter == null) {
            filter = new TransferEnquiriesAdapter.CustomFilter();
        }
        return filter;
    }
    ...
    private class CustomFilter extends Filter {
        ...
        protected void publishResults(CharSequence constraint, FilterResults filterResults) {
            if (filterResults.count > 0) {
                ...
                TransferEnquiriesAdapter.this.notifyDataSetChanged();
            } else {
