...
public class SaleParticipantsAdapter extends RecyclerView.Adapter<SaleParticipantsAdapter.SaleAdapter> implements RequestNotifier {
    ...
    @Override
    public void onBindViewHolder(final SaleParticipantsAdapter.SaleAdapter holder, int position) {

        final SaleMelaParticipantsResponse.Success obj = mParticipantList.get(position);
