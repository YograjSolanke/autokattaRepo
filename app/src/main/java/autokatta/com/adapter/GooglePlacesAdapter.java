...
public class GooglePlacesAdapter extends ArrayAdapter<String> implements Filterable {
    ...
    public static ArrayList<String> autocomplete(String input) {
        ...
        String BASE_API = "https://maps.googleapis.com/maps/api/place";
        String AUTOCMPLETE = "/autocomplete";
        String JSON = "/json";
        String API = "AIzaSyDQy-sYUScw5BJkClbJH6HC93gpk4B2Am4";
        ...
        try {
            StringBuilder sb = new StringBuilder(BASE_API + AUTOCMPLETE + JSON);
            sb.append("?key=" + API);
            ...
            Log.e("Error tag", "Error processing Places API URL", e);
            return resultList;
        } catch (IOException e) {
            Log.e("Error tag", "Error connecting to Places API", e);
            return resultList;
        } finally {
            if (conn != null) {
                conn.disconnect();
