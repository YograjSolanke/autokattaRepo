...
public class GroupProductContainer extends AppCompatActivity {

    GroupProductsFragment fragment;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_group_product_container);
        ...
        fragment = new GroupProductsFragment();
        if (b1 != null) {
            ...
            setTitle(b1.getString("bundle_GroupName") + " " + "Product's");
        }
            ...
            public void run() {
                try {
                    getSupportFragmentManager().beginTransaction()
                            .replace(R.id.productFrame, fragment, "productFrame")
                            .addToBackStack("productFrame")
                            .commit();
                } catch (Exception e) {
                    e.printStackTrace();
                }
