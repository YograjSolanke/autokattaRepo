...
public class UpdateMyVehicleRequest {

        @SerializedName("VehicleDataID")
        @Expose
    ...
    public UpdateMyVehicleRequest(String ids, String vehicle_no, String vehicle_type, String subcategory, String model_no, String brand,
                       String version, String year, String tax_validity, String fitness_validity, String permit_validity, String insurance,
                       String PUC, String last_service_date, String next_service_date)
{
    this.vehicleDataID=ids;
