...
public class GetGroupQuotationResponse {
    ...
    public class Success {
        ...
        public class UsedVehicle {
            ...
            @SerializedName("QuotationFor")
            @Expose
            private String quotationFor;
            @SerializedName("QuoteReservePrice")
            @Expose
            private String quoteReservePrice;
            @SerializedName("DeadLineDate_1")
            @Expose
            private Object deadLineDate1;
            ...
            public String getQuoteReservePrice() {
                return quoteReservePrice;
            }

            public void setQuoteReservePrice(String quoteReservePrice) {
                this.quoteReservePrice = quoteReservePrice;
            }

            public Object getDeadLineDate1() {
                return deadLineDate1;
            }

            public void setDeadLineDate1(Object deadLineDate1) {
