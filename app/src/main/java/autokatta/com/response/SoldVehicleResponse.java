...
public class SoldVehicleResponse {
    ...
    public class Success {
        ...
        @SerializedName("SoldVehicle")
        @Expose
        private List<SoldVehicle> soldVehicle = null;

        public List<SoldVehicle> getSoldVehicle() {
            return soldVehicle;
        }

        public void setSoldVehicle(List<SoldVehicle> soldVehicle) {
        ...
        public class SoldVehicle {
            ...
            @SerializedName("SoldVehicleID")
            @Expose
            private Integer soldVehicleID;
            @SerializedName("MyContact")
            @Expose
            private String myContact;
            @SerializedName("SoldToContact")
            @Expose
            private String soldToContact;
            @SerializedName("SoldDate_1")
            @Expose
            private String soldDate1;
            ...
            public Integer getSoldVehicleID() {
                return soldVehicleID;
            }

            public void setSoldVehicleID(Integer soldVehicleID) {
                this.soldVehicleID = soldVehicleID;
            }
            ...
            public void setSoldToContact(String soldToContact) {
                this.soldToContact = soldToContact;
            }

            public String getSoldDate1() {
                return soldDate1;
            }

            public void setSoldDate1(String soldDate1) {
                this.soldDate1 = soldDate1;
            }
