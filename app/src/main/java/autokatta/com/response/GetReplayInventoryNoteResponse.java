...
/**
 * Created by ak-005 on 9/11/17.
 */

public class GetReplayInventoryNoteResponse {
    @SerializedName("Success")
    @Expose
    private GetReplayInventoryNoteResponse.Success success;
    @SerializedName("Error")
    @Expose
    private Object error;

    public GetReplayInventoryNoteResponse.Success getSuccess() {
        return success;
    }

    public void setSuccess(GetReplayInventoryNoteResponse.Success success) {
    ...
    public class Success {
        ...
        @Expose
        private List<GetReplayInventoryNoteResponse.Success.ReviewMessage> reviewMessage = null;
        @SerializedName("ReplayMessage")
        @Expose
        private List<GetReplayInventoryNoteResponse.Success.ReplayMessage> replayMessage = null;

        public List<GetReplayInventoryNoteResponse.Success.ReviewMessage> getReviewMessage() {
            return reviewMessage;
        }

        public void setReviewMessage(List<GetReplayInventoryNoteResponse.Success.ReviewMessage> reviewMessage) {
            this.reviewMessage = reviewMessage;
        }

        public List<GetReplayInventoryNoteResponse.Success.ReplayMessage> getReplayMessage() {
            return replayMessage;
        }

        public void setReplayMessage(List<GetReplayInventoryNoteResponse.Success.ReplayMessage> replayMessage) {
        ...
        public class ReplayMessage {
            ...
            public void setLikestatus(Object likestatus) {
