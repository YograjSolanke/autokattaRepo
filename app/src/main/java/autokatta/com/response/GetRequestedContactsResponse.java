...
/**
 * Created by ak-005 on 29/9/17.
 */

public class GetRequestedContactsResponse {
    ...
    public class Success {
            ...
            public String getRequestedContact() {
                return requestedContact;
            }

            public void setRequestedContact(String requestedContact) {
