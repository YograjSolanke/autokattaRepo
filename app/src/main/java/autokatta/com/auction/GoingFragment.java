...
//                Snackbar.make(mGoing.findViewById(R.id.activity_autokatta_main), "Network Status: " + networkStatus, Snackbar.LENGTH_LONG).show();
        ...
        final RelativeLayout mAuctionEvent = (RelativeLayout) mGoing.findViewById(R.id.auction_event);
        RelativeLayout mLoanMela = (RelativeLayout) mGoing.findViewById(R.id.loan_mela_layout);
        RelativeLayout mExchangeEvent = (RelativeLayout) mGoing.findViewById(R.id.exchange_event_layout);
        ...
        TextView mLoanMelaCount = (TextView) mGoing.findViewById(R.id.loan_mela_count);
        TextView mExchangeEventCount = (TextView) mGoing.findViewById(R.id.exchange_event_count);
        mEventRecyclerView = (RecyclerView) mGoing.findViewById(R.id.event_recycler_view);
        RecyclerView mLoanMelaRecyclerView = (RecyclerView) mGoing.findViewById(R.id.loan_mela_recycler_view);
        RecyclerView mExchangeEventRecyclerView = (RecyclerView) mGoing.findViewById(R.id.exchange_event_recycler_view);
