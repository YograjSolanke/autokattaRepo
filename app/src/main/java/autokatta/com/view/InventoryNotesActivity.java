...
public class InventoryNotesActivity extends AppCompatActivity implements RequestNotifier, View.OnClickListener {
 ...
 //   KProgressHUD hud;
    ...
    int newvehicleid, product_id, service_id, vehicle_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inventory_notes);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        setTitle("Inventory Notes");

        mApiCall = new ApiCall(InventoryNotesActivity.this, this);
            ...
            public void run() {
                try {
                    ...
                    if (getIntent().getExtras() != null) {
                        newvehicleid = getIntent().getExtras().getInt("newvehicle_id", 0);
                   ...
                   /* hud = KProgressHUD.create(InventoryNotesActivity.this)
                            .setStyle(KProgressHUD.Style.SPIN_INDETERMINATE)
                            .setLabel("Please wait")
                            .setMaxProgress(100)
                            .show();*/
                    if (!mConnectionDetector.isConnectedToInternet()) {
                        Toast.makeText(InventoryNotesActivity.this, "Please check your internet connection", Toast.LENGTH_SHORT).show();
                    } else {
    ...
    public void sendmessage(final int review_id, final String keyword) {
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(InventoryNotesActivity.this);
        ...
        message.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                wordCount.setText(String.valueOf(1000 - s.length()));
            }
    ...
    public void notifySuccess(Response<?> response) {
        ...
        if (response != null) {
            ...
            //    hud.dismiss();
                 ...
                 */
                if (response.body() instanceof GetReplayInventoryNoteResponse) {
                    GetReplayInventoryNoteResponse moduleResponse = (GetReplayInventoryNoteResponse) response.body();
                    mainList.clear();
//                    childlist.clear();
                    GetReplayInventoryNoteResponse.Success object = moduleResponse.getSuccess();
                    for (GetReplayInventoryNoteResponse.Success.ReviewMessage obj : object.getReviewMessage()) {
                        ...
                        for (GetReplayInventoryNoteResponse.Success.ReplayMessage objectmatch : object.getReplayMessage()) {
    ...
    public void notifyString(String str) {
        if (str != null) {
           ...
           //     hud.dismiss();
            ...
            finish();
            Intent intent = new Intent(InventoryNotesActivity.this, InventoryNotesActivity.class);
            intent.putExtra("service_id", service_id);
            intent.putExtra("product_id", product_id);
            intent.putExtra("store_id", newvehicleid);
