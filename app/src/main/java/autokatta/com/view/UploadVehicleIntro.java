...
public class UploadVehicleIntro extends IntroActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (customFragments) {
            loginSlide = new FragmentSlide.Builder()
                    ...
                    .fragment(AboutStore.newInstance())
                    .build();
            addSlide(loginSlide);
        ...
        final Slide loginSlide1;
        if (customFragments) {
            loginSlide1 = new FragmentSlide.Builder()
                    .background(R.color.white)
                    .fragment(Katta.newInstance())
                    .build();
        ...
        addOnNavigationBlockedListener(new OnNavigationBlockedListener() {
            ...
            public void onNavigationBlocked(int position, int direction) {
                ...
                if (contentView != null) {
                    ...
                    }else if (slide == loginSlide1){
                        Snackbar.make(contentView, R.string.label_fill_out_form, Snackbar.LENGTH_LONG).show();
                    }else if (slide == loginSlide2){
                        Snackbar.make(contentView, R.string.label_fill_out_form, Snackbar.LENGTH_LONG).show();
                    }*/
                }
            }
