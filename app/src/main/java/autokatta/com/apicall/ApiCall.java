...
*/
 ...
 VehicleExchangeType
  */
    public void VehicleExchangeType(String custname, String custcont, String address, String fulladdr, String description, String ids, int VehiId) {
        try {
            if (mConnectionDetector.isConnectedToInternet()) {
                //JSON to Gson conversion
                Gson gson = new GsonBuilder()
                ...
                ServiceApi serviceApi = retrofit.create(ServiceApi.class);
                Call<String> updateStore = serviceApi._autokattaVehicleExchangeType(custname, custcont, address, fulladdr, description, ids, VehiId);
                updateStore.enqueue(new Callback<String>() {
                    @Override
                    public void onResponse(Call<String> call, Response<String> response) {
                        mNotifier.notifyString(response.body());
  ...
  */
    ...
    /*
 VehicleInventorySrcap
  */
    public void VehicleInventorySrcap(String custname, String custcontact, String address, String fulladdr, int purchaseprice, String purchasedate, int vehiID) {
        try {
            if (mConnectionDetector.isConnectedToInternet()) {
                //JSON to Gson conversion
                Gson gson = new GsonBuilder()
                ...
                ServiceApi serviceApi = retrofit.create(ServiceApi.class);
                Call<String> updateStore = serviceApi._autokattaVehicleInventorySrcap(custname, custcontact, address, fulladdr, purchaseprice, purchasedate, vehiID);
                updateStore.enqueue(new Callback<String>() {
                    @Override
                    public void onResponse(Call<String> call, Response<String> response) {
                        mNotifier.notifyString(response.body());
...
/*
    ...
    */
    ...
    public void getManualEnquiry(String myContact, int store_id) {
        try {
            if (mConnectionDetector.isConnectedToInternet()) {
                Retrofit retrofit = new Retrofit.Builder()
                        .baseUrl(mContext.getString(R.string.base_url))
                        ...
                        .build();
                ServiceApi serviceApi = retrofit.create(ServiceApi.class);
                Call<ManualEnquiryResponse> mServiceMelaResponse = serviceApi.getManualEnquiry(myContact, "null", "null", "null", "null", "null", "null", "null", "null", "null", "null", "null", 0, 0, "null", 0, store_id);
...
/*
      Get Transfer Manual Enquiry Details.to me..
    */

    public void getTransferedManualEnquiry(String myContact) {
        try {
            if (mConnectionDetector.isConnectedToInternet()) {
                Retrofit retrofit = new Retrofit.Builder()
                        .baseUrl(mContext.getString(R.string.base_url))
                        ...
                        .build();
                ServiceApi serviceApi = retrofit.create(ServiceApi.class);
                Call<ManualEnquiryResponse> mServiceMelaResponse = serviceApi.getTransferManualEnquiryToMe(myContact);
                mServiceMelaResponse.enqueue(new Callback<ManualEnquiryResponse>() {
                    @Override
                    public void onResponse(Call<ManualEnquiryResponse> call, Response<ManualEnquiryResponse> response) {
                        mNotifier.notifySuccess(response);
...
*/
    ...
    */
        ...
        try {
            if (mConnectionDetector.isConnectedToInternet()) {
                ...
                mSoldVehicle.enqueue(new Callback<SoldVehicleResponse>() {
                    ...
                    @Override
                    public void onFailure(Call<SoldVehicleResponse> call, Throwable t) {
                        mNotifier.notifyError(t);
                    }
                });
            } else
    ...
    /* get vehicles  for compare */
    public void getVehiclesForCompare(String vehicle_ids) {
        try {
            if (mConnectionDetector.isConnectedToInternet()) {
                Retrofit retrofit = new Retrofit.Builder()
                        .baseUrl(mContext.getString(R.string.base_url))
                ...
                ServiceApi serviceApi = retrofit.create(ServiceApi.class);
                Call<VehicleForCompareResponse> mCompareResponseCall = serviceApi._autokattaVehicleCompare(vehicle_ids);
                mCompareResponseCall.enqueue(new Callback<VehicleForCompareResponse>() {
                    @Override
                    public void onResponse(Call<VehicleForCompareResponse> call, Response<VehicleForCompareResponse> response) {
                        mNotifier.notifySuccess(response);
                    }

                    @Override
                    public void onFailure(Call<VehicleForCompareResponse> call, Throwable t) {
                        mNotifier.notifyError(t);
                    }
                });
            } else
...
*/
    ...
    public void uploadToGroupStore(int statusId, String groupIds, String storeIds) {
        try {
            if (mConnectionDetector.isConnectedToInternet()) {
                //JSON to Gson conversion
                Gson gson = new GsonBuilder()
                ...
                ServiceApi serviceApi = retrofit.create(ServiceApi.class);
                Call<String> mSoldVehicle = serviceApi._autokattauploadToGroupStore(statusId, groupIds, storeIds);
                mSoldVehicle.enqueue(new Callback<String>() {
                    @Override
                    public void onResponse(Call<String> call, Response<String> response) {
                        mNotifier.notifyString(response.body());
    ...
    public void GetNewVehicleDetailsForContact(String myContact, int pageNo, int viewRecords, int mStoreId) {
        try {
            if (mConnectionDetector.isConnectedToInternet()) {
                Retrofit retrofit = new Retrofit.Builder()
                        .baseUrl(mContext.getString(R.string.base_url))
                ...
                ServiceApi serviceApi = retrofit.create(ServiceApi.class);
                Call<NewVehicleAllResponse> mCompareResponseCall = serviceApi._autokattaGetNewVehicleDetailsForContact(myContact, pageNo, viewRecords, mStoreId);
                mCompareResponseCall.enqueue(new Callback<NewVehicleAllResponse>() {
                    @Override
                    public void onResponse(Call<NewVehicleAllResponse> call, Response<NewVehicleAllResponse> response) {
                        mNotifier.notifySuccess(response);
    ...
    /*get store New Vehicle List*/
    public void getStoreNewVehiclesList(int store_id) {
        try {
            if (mConnectionDetector.isConnectedToInternet()) {
                Retrofit retrofit = new Retrofit.Builder()
                        .baseUrl(mContext.getString(R.string.base_url))
                ...
                ServiceApi serviceApi = retrofit.create(ServiceApi.class);
                Call<NewVehicleAllResponse> mCompareResponseCall = serviceApi._autokattaGetStoreNewVehiclesList(store_id);
                mCompareResponseCall.enqueue(new Callback<NewVehicleAllResponse>() {
                    @Override
                    public void onResponse(Call<NewVehicleAllResponse> call, Response<NewVehicleAllResponse> response) {
                        mNotifier.notifySuccess(response);
    ...
    public void getUserCategories() {
        try {
            if (mConnectionDetector.isConnectedToInternet()) {
                ...
                ServiceApi serviceApi = retrofit.create(ServiceApi.class);
                Call<GetUserCategoryResponse> categoryResponseCall = serviceApi._autokattausercategory();
                categoryResponseCall.enqueue(new Callback<GetUserCategoryResponse>() {
                    @Override
                    public void onResponse(Call<GetUserCategoryResponse> call, Response<GetUserCategoryResponse> response) {
                        Log.i("loo", "" + response);
                        mNotifier.notifySuccess(response);
                    }

                    @Override
                    public void onFailure(Call<GetUserCategoryResponse> call, Throwable t) {
                        mNotifier.notifyError(t);
                    }
                });
            } else {
    ...
    public void addOtheruserCategory(String name) {
        try {
            if (mConnectionDetector.isConnectedToInternet()) {
                ...
                ServiceApi serviceApi = retrofit.create(ServiceApi.class);
                Call<String> forgetPasswordResponseCall = serviceApi.addOtheruserCategory(name);
                forgetPasswordResponseCall.enqueue(new Callback<String>() {
                    @Override
                    public void onResponse(Call<String> call, Response<String> response) {
                        mNotifier.notifyString(response.body());
...
/*Get Source of enquiry*/

    public void getSourceOfEnquiry() {
        try {
            if (mConnectionDetector.isConnectedToInternet()) {
                Retrofit retrofit = new Retrofit.Builder()
                        .baseUrl(mContext.getString(R.string.base_url))
                ...
                ServiceApi serviceApi = retrofit.create(ServiceApi.class);
                Call<GetSourceOfEnquiryResponse> categoryResponseCall = serviceApi._autokattagetsource();
                categoryResponseCall.enqueue(new Callback<GetSourceOfEnquiryResponse>() {
                    @Override
                    public void onResponse(Call<GetSourceOfEnquiryResponse> call, Response<GetSourceOfEnquiryResponse> response) {
                        Log.i("loo", "" + response);
                        mNotifier.notifySuccess(response);
                    }

                    @Override
                    public void onFailure(Call<GetSourceOfEnquiryResponse> call, Throwable t) {
                        mNotifier.notifyError(t);
                    }
                });
            } else {
    ...
    public void addOthersource(String name) {
        try {
            if (mConnectionDetector.isConnectedToInternet()) {
                ...
                ServiceApi serviceApi = retrofit.create(ServiceApi.class);
                Call<String> forgetPasswordResponseCall = serviceApi.addOthersource(name);
                forgetPasswordResponseCall.enqueue(new Callback<String>() {
                    @Override
                    public void onResponse(Call<String> call, Response<String> response) {
                        mNotifier.notifyString(response.body());
    ...
    public void addFinancerName(String name) {
        try {
            if (mConnectionDetector.isConnectedToInternet()) {
                ...
                ServiceApi serviceApi = retrofit.create(ServiceApi.class);
                Call<String> forgetPasswordResponseCall = serviceApi.addFienancername(name);
                forgetPasswordResponseCall.enqueue(new Callback<String>() {
                    @Override
                    public void onResponse(Call<String> call, Response<String> response) {
                        mNotifier.notifyString(response.body());
