            ...
            if (response.isSuccessful()) {
                if (response.body() instanceof CategoryResponse) {
                    ...
                    if (!brandsTagResponse.getSuccess().isEmpty()) {
                        ...
                        ArrayAdapter<String> dataadapter = new ArrayAdapter<>(this, R.layout.addproductspinner_color, brands);
            ...
            case R.id.checkproduct:
                ...
                if (uptype.equals("")) {
                    ...
                    spinCategory.clearFocus();
                               /* UpdateProductDetails productRequest = new UpdateProductDetails(setProductData(), ProductViewActivity.this);
