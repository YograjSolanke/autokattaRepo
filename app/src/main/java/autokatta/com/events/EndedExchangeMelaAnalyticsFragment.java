...
public class EndedExchangeMelaAnalyticsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, RequestNotifier {
    ...
    public void notifyError(Throwable error) {
        if (error instanceof SocketTimeoutException) {
            ...
            Log.i("Check Class-", "Ended Exchange Analytics Fragment");
