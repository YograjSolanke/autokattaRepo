...
public class EndedLoanMelaAnalyticsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, RequestNotifier {
    ...
    public void notifyError(Throwable error) {
        if (error instanceof SocketTimeoutException) {
            ...
            Log.i("Check Class-", "Ended Loan Analytics Fragment");
